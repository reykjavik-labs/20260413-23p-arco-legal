...
**Goal**: Producir la narrativa estratégica del producto y el PRD.md desde el cual comenzará el desarrollo. Dejar alineados a co-founders, socios estratégicos e interesados externos sobre qué se construye, por qué, y el roadmap.
**Depends on**: Nothing
...
- [ ] 00-02: PRD.md — personas, flujos, requisitos funcionales y no funcionales
